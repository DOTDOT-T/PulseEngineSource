...
#include "GameEntity.h"
 ...
 PulseEngine::EntityApi *PulseEngine::GameEntity::Instantiate(const std::string &path, PulseEngine::Vector3 position, PulseEngine::Vector3 rotation, PulseEngine::Vector3 scale)
 {
     ...
     return new PulseEngine::EntityApi(entity);
 }
